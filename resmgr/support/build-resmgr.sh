...
echo Building pf9-resmgr RPM ...
docker run --rm -i \
    -e PIP_INDEX_URL=https://artifactory.platform9.horse/artifactory/api/pypi/pypi/simple \
    -u $(id -u):$(id -g) \
    ...
    -w /src/pf9-du/resmgr/support \
    ${BUILD_IMAGE} /bin/bash -c "make unit-test && make rpm"
